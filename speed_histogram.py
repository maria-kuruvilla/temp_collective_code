...
def speed_histogram(x): 
    ...
    #plt.show()
    plt.xticks(ticks = [10,20,50,100], labels = [10,20,50,100])
    
    out_dir = parent_dir = '../../output/temp_collective/roi_figures/speed_pdf_log_log.png'
...
def acc_histogram(y): #replicates start from 1
    ...
    ax.hist(y, density=True, bins=10, log = True)
    ax.set_xscale('log')
    plt.xticks(ticks = [10,20,50,100,200], labels = [10,20,50,100,200])
    #ax.set_xlim(left = 5)
    #ax.set_ylim([0,0.0002])
